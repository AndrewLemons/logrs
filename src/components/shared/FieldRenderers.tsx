      ...
      <div class="form-group">
        ...
        {props.lookupStatus && props.lookupStatus !== "idle" && (
          <div class="lookup-status">
            {props.lookupStatus === "loading" && <><span class="spin">⟳</span> Looking up...</>}
            {props.lookupStatus === "found" && <><span class="status-dot success" /> Found</>}
            {props.lookupStatus === "not-found" && <><span class="status-dot error" /> Not found</>}
          </div>
        )}
      </div>
    );
